...
export const Slider: React.FC<SliderPropsType> = ({
    ...
    return (
        <View style={styles.container}>
            <View style={[styles.rangeLabelContainer, { width: width }]}>
                <Text style={styles.rangeLabel}>{min + 0}</Text>
            ...
            <View style={[styles.tackPath, { backgroundColor: "thistle" }, { width: width }]} />
